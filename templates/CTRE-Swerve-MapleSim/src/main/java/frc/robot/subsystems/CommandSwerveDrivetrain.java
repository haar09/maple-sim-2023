...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    /**
     * Returns the ground-truth pose of the maple-sim physics body (the pose that actually collides with field
     * obstacles). In simulation this can differ from {@link #getState()} odometry, which integrates wheel motion and
     * does not see collisions. Falls back to odometry when not simulating.
     */
